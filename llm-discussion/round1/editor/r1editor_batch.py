'''
    File: r1editor_batch.py
    Description: This file generates the OpenAI batch json files for round 1 discussions for the editor role in LLM Discussion tests.
'''
            ...
            input = {
                ...
                "body": {
                    ...
                    "messages": [
                        ...
                        {
                            "role": "assistant",
                            "content": f"{editor_response}"
                        },
                        {
                            "role": "user",
                            "content": (
                                "These are responses from other reviewers. PPlease revise your response if necessary and still limit your response to 150 tokens max.\n"
                                f"Response 1: {phd_response}\n"
                                f"Response 2: {prof_response}"
                            )
                        }
                    ],
                ...
                "body": {
                    ...
                    "messages": [
                        ...
                        },
                        {
                            "role": "user",
                            "content": (
                                "These are responses from other reviewers. Please revise your response if necessary and still limit your response to 150 tokens max.\n"
                                f"Response 1: {phd_response}\n"
                                f"Response 2: {prof_response}"
                            )
                        }
