'''
    File: r1phd_batch.py
    Description: This file generates the OpenAI batch json files for round 1 discussions for the phd role in LLM Discussion tests.
'''
