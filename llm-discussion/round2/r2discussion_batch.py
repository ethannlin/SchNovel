'''
    File: r2discussion_batch.py
    Description: This file generates the OpenAI batch json files for round 2 (final round) discussion in LLM Discussion tests.
'''
...
PROMPT = f'''You are the chair of this conference, and your primary role is a professor specializing in {CATEGORY}. You will be provided with the titles and abstracts of two research papers, along with the reviews from other reviewers. Your task is to determine which of the two articles is more novel by evaluating their originality, contribution to the field, and potential impact. You must consider both your own expertise and the feedback from the other reviewers.
...
# Path to results from round 1 editor
EDITOR_RESULTS = ""

# Path to results from round 1 phd
PHD_RESULTS = ""

# Path to results from round 1 professor
PROF_RESULTS = ""
                ...
                "body": {
                    ...
                    "messages": [
                        ...
                        },
                        {
                            "role": "user",
                            "content": (
                                "These are responses from other reviews. Please determine which paper is more novel. Please still limit your response to 150 tokens max and conclude with 'The more novel and impactful paper is [Paper X or Paper Y]'\n"
                                f"Response 1: {phd_response}\n"
                                f"Response 2: {editor_response}\n"
                                f"Response 3: {prof_response}"
                            )
                        }
                    ],
